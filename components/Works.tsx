...
const projects = [
  {
    ...
    deskImages:[
      ...
      },
      {
        ...
        paragraph:"Designed to prioritize reviews with images to optimize conversation rates greatly. As for questions, questions can be asked by verified users, questions will not be public untill an admin approves the message and replies to it.",
      ...
      },
      {
        ...
        paragraph:"Advanced filtering system for collections.",
  ...
  },
  {
    ...
    objective:'My objective was to create an app to help me understand my credit card debt. I made sure to include penalty costs of not paying off a debt that was due, and how long I had to pay off that debt.',
    responsibility:"UI Design & Development",
    ...
    deskImages:[
      ...
      },
      {
        ...
        paragraph:"One thing that was definitley important to me was checking my expenses. Thanks to Plaid, I was able to create an overview for my account. I was able to show available balance, total spent & total earned within a set amount of time. (6 mo, 12 mo,ytd, or 24 mo)",
  ...
  },
  {
    ...
    objective:'Create an customizable e-commerce site for a client. My client had to be able to customize the product description, pricing, and images if they wished to do so. My client also needed a site that was fast and optimized for conversions.',
    responsibility:"UI Design & Development",
    ...
    deskImages:[
      ...
      },
      {
        ...
        paragraph:"My biggest challenge was creating something that would maximize conversions. I figured, designing a beautifully made about section about the product along with FAQ's & reviews would maximize conversions as much as possible.",
        urls:[
  ...
  },
  {
    ...
    longDesc:'Blog is a personal blog site I decided to create after being inspired on dribbble. I wanted to make it as feature packed as possible!',
    ...
    deskImages:[
      ...
      },
      {
        ...
        paragraph:"All authors have a public profile where it is able to be shared publicly.",
      ...
      {
        heading:"Comments",
        paragraph:"Verified users may leave comments on blog posts. Author's of that post have the ability to delete any comment from their posts.",
...
const Works:React.FC = () => {
  ...
  return (
    <React.Fragment>
      <section className = "px-6 py-16 mx-auto max-w-7xl">
        <div className = "flex flex-col gap-20 mt-16">
          {projects.map((project)=>(
            <div className = {`flex lg:flex-row flex-col`} key = {project.title}>
              ...
              <div 
                className = "flex-1 mt-4 overflow-hidden bg-gray-200 cursor-pointer rounded-xl aspect-video"
                onClick = {()=>handleProjectClick(project.title)}
              >
      ...
      <ExpandProject expand = {expand} setExpand = {setExpand} project = {project}/>
    </React.Fragment>
  )
}
...
const ExpandProject:React.FC<ExpandProps> = ({expand,setExpand,project})=>{
  const router = useRouter()
  ...
  return(
    <React.Fragment>
      <div className = {`fixed inset-0  ${expand ? 'translate-y-0' : 'translate-y-full' } bg-white transition duration-1000 overflow-y-scroll`}>
        <div className = "mx-auto mb-16">
          <div className = "sticky top-0 z-10 bg-black/70 backdrop-blur-lg">
            <div className="px-6 mx-auto max-w-7xl">
              <p 
                className = "py-3 text-sm text-white cursor-pointer pointer-events-auto w-max"
                    ...
                    <div className = "flex flex-col items-center justify-center mt-10">
                      {prj?.deskImages?.map((image)=>(
                        <>
                          ...
                          <div className = "w-full h-full p-6 mb-10 bg-gray-50 md:py-12 md:px-32">
